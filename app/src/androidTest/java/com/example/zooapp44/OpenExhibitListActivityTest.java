...
//    public IntentsTestRule<OpenExhibitListActivity> intentsTestRule = new IntentsTestRule<>(OpenExhibitListActivity.class);
    ...
    public void testOpenExhibitListActivityNoneEmptyList(){
        ...
        List<ZooGraph.Vertex> vertices =
                                Arrays.asList(graph.getVertex("entrance gate", ZooGraph.Kind.GATE, true,"",330,330),
                                                graph.getVertex("tiger", ZooGraph.Kind.EXHIBIT, true,"",330,330),
                                                graph.getVertex("intersaction", ZooGraph.Kind.INTERSECTION, true,"",330,330),
                                                graph.getVertex("bird", ZooGraph.Kind.EXHIBIT, false,"",330,330),
                                                graph.getVertex("lion", ZooGraph.Kind.EXHIBIT, true,"",330,330));
