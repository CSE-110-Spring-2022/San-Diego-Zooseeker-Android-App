...
public abstract class ToAddDatabase extends RoomDatabase {
    ...
    public abstract ToAddExhibitsDao tooaddExhibitsDao();
    ...
    private  static   ToAddDatabase makeDatabase(Context context){
        return Room.databaseBuilder(context,  ToAddDatabase.class, "todo_app.db").allowMainThreadQueries()
                .addCallback(new Callback() {
                    ...
                    public  void onCreate(@NonNull SupportSQLiteDatabase db){
                        ...
                        Executors.newSingleThreadScheduledExecutor().execute(()->{
                            ...
                            getSingleton(context).tooaddExhibitsDao().insertAll(todos);
                        });
                    }
                }).build();
    }
